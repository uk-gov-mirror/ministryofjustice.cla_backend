...
class EligibilityCheckViewSet(
    ...
    # DRF 2.3 -> 2.4 "@detail_route and @list_route decorators replace @action and @link."
    #  from https://github.com/encode/django-rest-framework/blob/version-2.4.x/docs/topics/release-notes.md#240
    # action decorator method was POST
    #  from  https://github.com/encode/django-rest-framework/blob/2.3.14/docs/api-guide/routers.md#defaultrouter
